...
public:
    ...
    static void _reset_frame_buffer_resized() {
        framebuffer_resized = false;
    }

    static bool get_frame_buffer_resized() {
        return framebuffer_resized;
    }

    static u8 get_current_frame() {
    ...
    static void initialize_context(const char *title, u32 width, u32 height) {
