...
enum NanoTextmentHorizontal : u8
{
    NANO_TEXT_HORIZONTAL__LEFT = 0,
    NANO_TEXT_HORIZONTAL__CENTER = 1,
    NANO_TEXT_HORIZONTAL__RIGHT = 2,

    TEXT_HORIZONTAL__LEFT   = NANO_TEXT_HORIZONTAL__LEFT,
    TEXT_HORIZONTAL__CENTER = NANO_TEXT_HORIZONTAL__CENTER,
    TEXT_HORIZONTAL__RIGHT  = NANO_TEXT_HORIZONTAL__RIGHT,
};

enum NanoTextmentVertical : u8
{
    NANO_TEXT_VERTICAL__BASELINE = 0,
    NANO_TEXT_VERTICAL__TOP      = 1,
    NANO_TEXT_VERTICAL__CENTER   = 2,
    NANO_TEXT_VERTICAL__BOTTOM   = 3,
    
    TEXT_VERTICAL__TOP      = NANO_TEXT_VERTICAL__TOP,
    TEXT_VERTICAL__CENTER   = NANO_TEXT_VERTICAL__CENTER,
    TEXT_VERTICAL__BOTTOM   = NANO_TEXT_VERTICAL__BOTTOM,
    TEXT_VERTICAL__BASELINE = NANO_TEXT_VERTICAL__BASELINE,
};
...
struct TextRenderInfo {
    ...
    float y;
    std::string line;
    NanoTextmentHorizontal horizontal;
    NanoTextmentVertical vertical;
};
...
struct TextRendererSingleton
{
    ...
    void RenderLine(const f32 x, f32 y, const std::string_view line, const NanoTextmentHorizontal horizontal, const f32 scale, const NanoFont* font);
